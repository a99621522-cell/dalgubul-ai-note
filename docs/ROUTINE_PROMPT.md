...
**스크랩이 아니라 정책(운영자 지시 2026-09-26)**: 이 리포트는 자료 모음이 아니라 정책 제안서다. 기관 발간물·기사에서 사실을 가져올 때는 반드시 (가) 그 자료의 논지·수치·조건을 읽고 (나) 대구 기업 사전 숫자와 연결해 (다) "대구에서는 무엇이 다르고 그래서 무엇을 해야 하는가"를 한 문장 이상 쓴다. 제목만 아는 자료는 인용하지 않는다("제목 기준"·"본문 미확인" 표기 금지 — 검사기가 오류로 본다). 사실을 나열한 문단 뒤에는 반드시 해석 문장(대구 시사점)이 따른다. 4~6절은 7절 제안의 근거를 만드는 분석이고, 7절은 정책 설계(문제 정의 → 원인 분석 → 수단 선택과 대안 비교 → 추진 체계 → 대상·지표)다.

근거의 우선순위
0. **분야 담당 기관 먼저** — config/research_sources.yml 에서 `areas` 에 이 분야 key 가 있는 기관(예: 뿌리산업 = 한국생산기술연구원·국가뿌리산업진흥센터, 섬유 = 한국섬유산업연합회·한국섬유개발연구원·다이텍연구원·한국섬유소재연구원, 기계 = 한국기계연구원, 자동차 = 한국자동차연구원, 로봇 = 로봇산업진흥원·로봇산업협회, 반도체 = 반도체산업협회, 의료기기 = 의료기기산업협회·케이메디허브, AI·SW = 소프트웨어정책연구소·NIPA, 소재 = 한국재료연구원, 대구 = 대구정책연구원·대구TP). report_context 가 "[분야기관]" 표시로 먼저 출력하고, `요지`(본문 앞 1,500자)가 있는 항목은 `python3 scripts/fetch_research.py --query <낱말> --excerpt` 로 읽는다. 6절의 3~5편 가운데 2편 이상은 분야 기관 자료로 한다.
...
1 결론 먼저(제안 3개, 각 한 문장에 대상·수단·규모) → 2 지난 제안 점검(1주 전 리포트의 제안이 공고·시 발표·기관 사업에 반영됐는지 사실만, 첫 회차 생략, 변화 없으면 "변화 없음"과 확인 자료 이름·건수) → 3 현재 위치(기업 사전 숫자: 기업·고용·전국 비중·규모 분포·단지, 최근 8주 대구 신호) → 4 글로벌 변화와 대구 노출(사건 3~5개, 각각 "대구 기업 ○곳·○명이 직접 관련(계산 근거)") → 5 정부·타도시 움직임(정부 사업 사업명·신규 여부·일정, 대구시 추진 사업, 경쟁 도시 비교표 1개, 예산액 없이) → 6 연구기관·시장 시각(3~5편, 2편 이상은 분야 담당 기관. 편마다 3줄: ① 자료의 논지와 핵심 수치·조건, ② 그 논지가 대구 기업 사전 숫자에 어떻게 닿는가, ③ "대구 …" 로 시작하는 시사점 한 문장. 다른 관점 1편 이상 포함. 제목만 아는 자료 인용 금지) → 7 정책 제안(2026-09-28 부터 정책 설계 형식. "### 제안 N (시)" / "### 제안 N (정부 건의)" / "### 제안 N (기업·기관)", 제안마다 여덟 항목: "- 문제:" 숫자로 정의한 현상 / "- 분석:" 그 문제가 대구에서 생기는 원인·구조와 4~6절 어느 분석에서 나왔는가 / "- 제안:" 무엇을 누가 언제(연계 사업은 사업명만) / "- 추진:" 추진 주체·절차·기간·필요한 결정(조례·공고·협약 등) / "- 대안:" 검토한 다른 수단 2개와 택하지 않은 이유 / "- 근거:" 4·5·6절 번호 / "- 대상 규모:" 기업 사전 필터 결과 '○곳'과 조건 / "- 지표:" 1년 뒤 성공 기준) → 8 반론(반대 근거 한 단락 + 틀릴 수 있는 이유 두 줄) → 9 출처("외부 출처 N건은 이 글 아래 '출처' 목록에 링크로 있다", 확인 상태: 기관 발간물 N건 날짜·링크 확인 / 검색 요지 N건 원문 대조 필요, 내부 근거 파일 이름과 기업 사전 기준월).
